...
export function CSVUploader({ label, description, onUpload, onDownloadTemplate }: CSVUploaderProps) {
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        {onDownloadTemplate && (
          <button
            ...
            style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--mod-mfa)', fontSize: 'var(--text-xs)', display: 'flex', alignItems: 'center', gap: 4 }}
          >
      ...
      {!file ? (
        <label
          ...
          style={{
            ...
            padding: 'var(--space-6)',
            border: `1px dashed ${dragOver ? 'var(--mod-mfa)' : 'var(--border-default)'}`,
            borderRadius: 'var(--radius-md)',
            backgroundColor: dragOver ? 'color-mix(in srgb, var(--mod-mfa) 6%, transparent)' : 'var(--bg-elevated)',
            cursor: 'pointer',
        ...
        <div style={{ padding: 'var(--space-4)', backgroundColor: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)', borderRadius: 'var(--radius-md)', display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <FileSpreadsheet size={16} color="var(--mod-mfa)" />
          ...
          <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
            ...
            <Button variant="primary" onClick={handleSubmit} disabled={uploading} style={{ backgroundColor: 'var(--mod-mfa)' }}>
